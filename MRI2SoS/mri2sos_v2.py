...
optimizer_G_A2B = torch.optim.Adam(G_A2B.parameters(), lr=p.lr, betas=(beta1, 0.999))
optimizer_G_B2A = torch.optim.Adam(G_B2A.parameters(), lr=p.lr, betas=(beta1, 0.999))
